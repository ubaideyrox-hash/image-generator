...
var assets = require('../app/controllers/assets'),
   ...
   var templateController  = require('../app/controllers/templateController');
...
router.post('/api/users/:id', userController.updateUser)
router.post('/api/login', userController.userLogin)
///////////////////////////////////////////

//// Template Api's /////////////////////////
router.post('/api/template', templateController.createTemplate);
router.get('/api/template/:id', templateController.getTemplateById);
router.get('/api/templates', templateController.gettemplates);
router.delete('/api/template/:id', templateController.deleteTemplate);
router.post('/api/template/:id', templateController.updateTemplate);

///////////////////////////////////////////

router.get('/api/files/:user_id', assets.index);
...
router.get('/api/playlisting/:user_id', playlists.index);
...
// group routes
router.get('/api/groups/:user_id', groups.index)
...
router.get('/api/getplayers/:id', players.getMoniterInfo)
...
router.get('/api/labels/:user_id', labels.index);
